		...
		<div class="navbar-inner">
			<div class="container-fluid">
				<a href="#" class="brand"> <small> <i class="icon-book"></i>
						Sistema Gesti&oacute;n de Proyectos
				</small>
				</a>
				<!--/.brand-->
						...
						<div class="row-fluid">
							<div class="center">
								...
								<c:if test="${param.expired != null}">
									<div class="alert alert-error">La Sesi&oacute;n se ha cerrado a
										la fuerza debido a varias sesiones en la misma cuenta (s&oacute;lo se
										permite una sesi&oacute;n activa por usuario).</div>
								</c:if>

								<c:if test="${param.timeout != null}">
									<div class="alert alert-error">Tiempo de Sesi&oacute;n
										Terminado</div>
								</c:if>
