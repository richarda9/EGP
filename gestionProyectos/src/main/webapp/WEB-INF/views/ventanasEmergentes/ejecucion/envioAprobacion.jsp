<!-- [INI] MODAL ENVIAR A APROBACION-->
<form id="registrarEnvioAprobacion">
	<div id="modal-EnviarAprobacion" class="modal hide" tabindex="-1">
		<div class="modal-header">
			<button type="button" class="close" data-dismiss="modal">&times;</button>
			<h4 class="blue bigger">Env&iacute;o de Entregables</h4>
		</div>
			...
			<div class="row-fluid">
				...
				<div class="span9">
					...
					<div class="row-fluid">
						...
						<div class="span10"><input type="file" id="envioEntregableAprobacion" /></div>
					</div>
				</div>
			</div>	
			<div class="row-fluid">
