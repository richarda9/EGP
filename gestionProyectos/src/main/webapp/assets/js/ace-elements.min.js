	...
	a.fn.ace_wysiwyg = function(c, h) {
		...
		var g = {
			...
			outdent : {
				...
				title : "Reducir sangría (Mayús + Tabulación)"
			},
			indent : {
			...
			unlink : {
				icon : "icon-unlink",
				title : "Eliminar hipervínculo"
			},
			insertImage : {
				icon : "icon-picture",
				title : "Insertar imagen",
				button_text : '<i class="icon-file"></i> Elegir imagen &hellip;',
			...
			backColor : {
				values : e,
				title : "Cambiar el color de fondo"
			},
			undo : {
				icon : "icon-undo",
